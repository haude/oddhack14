var popnDensity = {
    ...
    district:{
        data:{
            taplejung:{metric:134698, text:''},
            panchthar:{metric:202056, text:''},
            illam:{metric:282806, text:''},
            jhapa:{metric:688109, text:''},
            morang:{metric:843220, text:''},
            sunsari:{metric:625633, text:''},
            dhankuta:{metric:166479, text:''},
            terathum:{metric:113111, text:''},
            sankhuwasava:{metric:159203, text:''},
            bhojpur:{metric:203018, text:''},
            solukhumbu:{metric:107686, text:''},
            okhaldhunga:{metric:156702, text:''},
            khotang:{metric:231385, text:''},
            udaypur:{metric:287689, text:''},
            saptari:{metric:570282, text:''},
            siraha:{metric:572399, text:''},
            dhanusa:{metric:671364, text:''},
            mahattori:{metric:553481, text:''},
            sarlahi:{metric:635701, text:''},
            sindhuli:{metric:279821, text:''},
            ramechhap:{metric:212408, text:''},
            dolakha:{metric:204229, text:''},
            sindhupalchok:{metric:305857, text:''},
            kavre:{metric:385672, text:''},
            lalitpur:{metric:337785, text:''},
            bhaktapur:{metric:225461, text:''},
            kathmandu:{metric:1081845, text:''},
            nuwakot:{metric:288478, text:''},
            rasuwa:{metric:44731, text:''},
            dhading:{metric:338658, text:''},
            makwanpur:{metric:392604, text:''},
            rautahat:{metric:545132, text:''},
            bara:{metric:559135, text:''},
            parsa:{metric:497219, text:''},
            chitwan:{metric:472048, text:''},
            gorkha:{metric:288134, text:''},
            lamjung:{metric:177149, text:''},
            tanahu:{metric:315237, text:''},
            syanja:{metric:317320, text:''},
            kaski:{metric:380527, text:''},
            manang:{metric:9587, text:''},
            mustang:{metric:14981, text:''},
            myagdi:{metric:114447, text:''},
            parbat:{metric:157826, text:''},
            baglung:{metric:268937, text:''},
            gulmi:{metric:296654, text:''},
            palpa:{metric:268558, text:''},
            nawalparasi:{metric:562870, text:''},
            rupandehi:{metric:708419, text:''},
            kapilvastu:{metric:481976 , text:''},
            arghakhanchi:{metric:208391, text:''},
            pyuthan:{metric:212484, text:''},
            rolpa:{metric:210004, text:''},
            rukum:{metric:188438, text:''},
            salyan:{metric:213500, text:''},
            dang:{metric:462380, text:''},
            banke:{metric:385840, text:''},
            bardia:{metric:382649, text:''},
            surkhet:{metric:288527, text:''},
            dailekh:{metric:225201, text:''},
            jajarkot:{metric:134868, text:''},
            dolpa:{metric:29545, text:''},
            jumla:{metric:89427, text:''},
            kalikot:{metric:105580, text:''},
            mugu:{metric:43937, text:''},
            humla:{metric:40595, text:''},
            bajura:{metric:108781, text:''},
            bajhang:{metric:167026, text:''},
            achham:{metric:231285, text:''},
            doti:{metric:207066, text:''},
            kailali:{metric:616697, text:''},
            kanchanpur:{metric:377899, text:''},
            dadeldhura:{metric:126162, text:''},
            baitadi:{metric:234418 , text:''},
            darchula:{metric:121996, text:''}
        },
